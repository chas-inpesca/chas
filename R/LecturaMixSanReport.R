rm(list=ls())
source("~/ADMwork/MixSan2013/Rstuff/MixSanFunctions/read.admb.R")
source("~/ADMwork/MixSan2013/Rstuff/MixSanFunctions/FunctionMixSAN.R")
setwd("~/ADMwork/MixSan2013/MixSANIFOPv2/")

san <- read.admb("mixsanifopv2")
names(san)
#Biomasa
quartz()
